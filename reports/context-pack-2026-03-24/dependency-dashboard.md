...
<details><summary>docker-compose.yml (13)</summary>
 ...
 - `supabase/realtime v2.78.11` → [Updates: `v2.78.17`]
 - `supabase/storage-api v1.42.2` → [Updates: `v1.44.11`]
 ...
 - `supabase/postgres 17.6.1.095` → [Updates: `17.6.1.102`]
...
<details><summary>platform/renovate/Chart.yaml (1)</summary>
 ...
 - `renovate 46.56.2` → [Updates: `46.84.0`]
...
<details><summary>system/monitoring-system/Chart.yaml (1)</summary>
 ...
 - `kube-prometheus-stack 82.10.1` → [Updates: `82.13.6`]
