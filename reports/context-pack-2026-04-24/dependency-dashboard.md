...
The following updates have been manually edited so Renovate will no longer make changes. To discard all commits and start over, click on a checkbox below.
 ...
 - [ ] <!-- rebase-branch=renovate/all-minor-patch -->[fix(deps): update all non-major dependencies](pulls/80) (`argo-cd`, `cert-manager`, `curlimages/curl`, `darthsim/imgproxy`, `external-secrets`, `ghcr.io/gethomepage/homepage`, `ghcr.io/kagent-dev/doc2vec/mcp`, `ghcr.io/kagent-dev/kagent/tools`, `gitea`, `go`, `k8s.io/api`, `k8s.io/apimachinery`, `k8s.io/client-go`, `kube-prometheus-stack`, `kubernetes`, `nginx`, `nvidia/cuda`, `ollama`, `quay.io/ceph/ceph`, `registry.k8s.io/kubectl`, `registry.rocket.chat/rocketchat/rocket.chat`, `renovate`, `rook-ceph`, `rook-ceph-cluster`, `supabase/edge-runtime`, `supabase/logflare`, `supabase/postgres`, `supabase/postgres-meta`, `supabase/realtime`, `supabase/storage-api`, `timberio/vector`, `zot`)
...
The following updates have all been created. To force a retry/rebase of any, click on a checkbox below.
 ...
 - [ ] <!-- rebase-branch=renovate/bitnamilegacy-postgresql-17.x -->[chore(deps): update bitnamilegacy/postgresql docker tag to v17](pulls/81)
 - [ ] <!-- rebase-branch=renovate/kube-prometheus-stack-84.x -->[chore(deps): update helm release kube-prometheus-stack to v84](pulls/83)
...
The following updates are blocked by an existing closed PR. To recreate the PR, click on a checkbox below.
 ...
 - [ ] <!-- recreate-branch=renovate/nextcloud-9.x -->[chore(deps): update helm release nextcloud to v9](pulls/74)
...
<details><summary>docker-compose.yml (13)</summary>
 ...
 - `supabase/realtime v2.80.2` → [Updates: `v2.86.3`]
 - `supabase/storage-api v1.48.8` → [Updates: `v1.55.0`]
 - `darthsim/imgproxy v3.31.1` → [Updates: `v3.31.2`]
 - `supabase/postgres-meta v0.96.2` → [Updates: `v0.96.4`]
 - `supabase/edge-runtime v1.73.0` → [Updates: `v1.73.15`]
 - `supabase/logflare 1.35.1` → [Updates: `1.39.1`]
 - `supabase/postgres 17.6.1.104` → [Updates: `17.6.1.110`]
 - `timberio/vector 0.54.0-alpine` → [Updates: `0.55.0-alpine`]
...
<details><summary>dockerfile (12)</summary>
<blockquote>
...
<details><summary>apps/pages/Dockerfile</summary>


</details>

<details><summary>apps/scribe/Dockerfile (1)</summary>
...
<details><summary>archived/apps/heartlib/Dockerfile (2)</summary>
 ...
 - `nvidia/cuda 13.2.0-devel-ubuntu22.04` → [Updates: `13.2.1-devel-ubuntu22.04`]
 - `nvidia/cuda 13.2.0-runtime-ubuntu22.04` → [Updates: `13.2.1-runtime-ubuntu22.04`]

</details>

<details><summary>archived/apps/paperclip/Dockerfile</summary>


</details>

<details><summary>archived/apps/scribe/Dockerfile (1)</summary>
...
<details><summary>metal/roles/pxe_server/files/http/Dockerfile (1)</summary>
 ...
 - `nginx 1.29-alpine` → [Updates: `1.30-alpine`]
...
<details><summary>platform/global-secrets/files/secret-generator/go.mod (7)</summary>
 ...
 - `gopkg.in/yaml.v3 v3.0.1`
 - `k8s.io/api v0.35.3` → [Updates: `v0.36.0`]
 - `k8s.io/apimachinery v0.35.3` → [Updates: `v0.36.0`]
 - `k8s.io/client-go v0.35.3` → [Updates: `v0.36.0`]
...
<details><summary>helm-values (94)</summary>
<blockquote>

<details><summary>apps/backlog-canary/values.yaml (2)</summary>

 - `10.0.20.11:32309/backlog_backend 2026-04-23-v1-canary`
 - `10.0.20.11:32309/backlog_frontend 2026-04-24-v2-canary`

</details>

<details><summary>apps/backlog/values.yaml (2)</summary>

 - `10.0.20.11:32309/backlog_backend 2026-04-24-v1-prod`
 - `10.0.20.11:32309/backlog_frontend 2026-04-24-v2-prod`
...
<details><summary>apps/echo/values.yaml</summary>
...
<details><summary>apps/localai/values.yaml</summary>
...
<details><summary>apps/nibble-canary/values.yaml (1)</summary>

 - `10.0.20.11:32309/nibble 2026-04-24-v2-canary`

</details>

<details><summary>apps/nibble/values.yaml (1)</summary>

 - `10.0.20.11:32309/nibble 2026-04-24-v2-prod`

</details>

<details><summary>apps/opencode-server/values.yaml (1)</summary>

 - `10.0.20.11:32309/opencode-server 2026-04-06-v1`
...
<details><summary>apps/pages-canary/values.yaml</summary>


</details>

<details><summary>apps/pages/values.yaml (1)</summary>

 - `10.0.20.11:32309/pages 2026-04-22-v1-prod`

</details>

<details><summary>apps/podwave/values.yaml (1)</summary>

 - `10.0.20.11:32309/podwave 2026-04-03-v69`
...
<details><summary>apps/scribe-canary/values.yaml (1)</summary>

 - `10.0.20.11:32309/scribe 2026-04-061430-v1-canary`

</details>

<details><summary>apps/scribe/values.yaml (1)</summary>

 - `10.0.20.11:32309/scribe 2026-04-06-v3`
...
<details><summary>apps/second-brain-canary/values.yaml (1)</summary>

 - `10.0.20.11:32309/second-brain 2026-04-17-v1-canary`

</details>

<details><summary>apps/second-brain/values.yaml (1)</summary>

 - `10.0.20.11:32309/second-brain 2026-04-17-v1-prod`
...
<details><summary>archived/apps/homepage/values.yaml (1)</summary>
 ...
 - `ghcr.io/gethomepage/homepage v1.12.1` → [Updates: `v1.12.3`]

</details>

<details><summary>archived/apps/kagent/values.yaml (2)</summary>

 - `ghcr.io/kagent-dev/kagent/tools 0.1.3` → [Updates: `0.1.4`]
 - `ghcr.io/kagent-dev/doc2vec/mcp 2.9.2` → [Updates: `2.11.0`]
...
<details><summary>archived/apps/llama/values.yaml (1)</summary>
 ...
 - `curlimages/curl 8.18.0` → [Updates: `8.19.0`]
...
<details><summary>archived/apps/ollama/values.yaml (1)</summary>
...
<details><summary>archived/apps/paperclip/values.yaml (3)</summary>
...
<details><summary>archived/apps/rocket/values.yaml (3)</summary>
 ...
 - `registry.rocket.chat/rocketchat/rocket.chat 8.2.1` → [Updates: `8.3.2`]
 - `mongo 8`
 - `mongo 8`

</details>

<details><summary>archived/apps/scribe/values.yaml</summary>
...
<details><summary>platform/kanidm/values.yaml (1)</summary>
 ...
 - `docker.io/kanidm/server 1.9.2`

</details>

<details><summary>system/cloudflared/values.yaml (1)</summary>

 - `docker.io/cloudflare/cloudflared 2026.3.0`
...
<details><summary>system/rook-ceph/values.yaml (2)</summary>
 ...
 - `quay.io/ceph/ceph v20.2.0` → [Updates: `v20.2.1`]
 - `registry.k8s.io/kubectl v1.35.3` → [Updates: `v1.36.0`]
...
<details><summary>helmv3 (97)</summary>
<blockquote>
...
<details><summary>apps/echo/Chart.yaml (1)</summary>
...
<details><summary>apps/localai/Chart.yaml (1)</summary>
...
<details><summary>apps/nextcloud/Chart.yaml (1)</summary>
 ...
 - `nextcloud 8.9.1` → [Updates: `9.0.5`]

</details>

<details><summary>apps/nibble-canary/Chart.yaml (1)</summary>

 - `app-template 4.6.2`

</details>

<details><summary>apps/nibble/Chart.yaml (1)</summary>

 - `app-template 4.6.2`

</details>

<details><summary>apps/opencode-server/Chart.yaml (1)</summary>
...
<details><summary>apps/pages-canary/Chart.yaml (1)</summary>

 - `app-template 4.6.2`

</details>

<details><summary>apps/pages/Chart.yaml (1)</summary>

 - `app-template 4.6.2`

</details>

<details><summary>apps/podwave/Chart.yaml (1)</summary>
...
<details><summary>apps/scribe-canary/Chart.yaml (1)</summary>

 - `app-template 4.6.2`

</details>

<details><summary>apps/scribe/Chart.yaml (1)</summary>
...
<details><summary>apps/second-brain-canary/Chart.yaml (1)</summary>

 - `app-template 4.6.2`

</details>

<details><summary>apps/second-brain/Chart.yaml (1)</summary>
...
<details><summary>archived/apps/ollama/Chart.yaml (1)</summary>

 - `ollama 1.54.0` → [Updates: `1.55.0`]
...
<details><summary>archived/apps/paperclip/Chart.yaml (1)</summary>
...
<details><summary>archived/apps/scribe/Chart.yaml (1)</summary>
...
<details><summary>platform/external-secrets/Chart.yaml (1)</summary>
 ...
 - `external-secrets 2.2.0` → [Updates: `2.3.0`]

</details>

<details><summary>platform/gitea/Chart.yaml (1)</summary>

 - `gitea 12.5.0` → [Updates: `12.5.3`]
...
<details><summary>platform/renovate/Chart.yaml (1)</summary>
 ...
 - `renovate 46.97.2` → [Updates: `46.130.1`]
...
<details><summary>platform/zot/Chart.yaml (1)</summary>
 ...
 - `zot 0.1.104` → [Updates: `0.1.106`]

</details>

<details><summary>system/argocd/Chart.yaml (2)</summary>

 - `argo-cd 9.4.17` → [Updates: `9.5.4`]
 - `argocd-apps 2.0.4`
...
<details><summary>system/cert-manager/Chart.yaml (1)</summary>
 ...
 - `cert-manager v1.20.1` → [Updates: `v1.20.2`]
...
<details><summary>system/monitoring-system/Chart.yaml (1)</summary>
 ...
 - `kube-prometheus-stack 82.15.1` → [Updates: `82.18.0`, `84.0.1`]

</details>

<details><summary>system/rook-ceph/Chart.yaml (3)</summary>

 - `rook-ceph v1.19.3` → [Updates: `v1.19.4`]
 - `rook-ceph-cluster v1.19.3` → [Updates: `v1.19.4`]
...
<details><summary>external/modules/cloudflare/versions.tf (3)</summary>
 ...
 - `cloudflare ~> 5.18.0`
 - `http ~> 3.5.0`
 - `kubernetes ~> 3.0.0` → [Updates: `~> 3.1.0`]
