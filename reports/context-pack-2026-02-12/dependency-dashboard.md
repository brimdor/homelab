...
The following updates have all been created. To force a retry/rebase of any, click on a checkbox below.
 ...
 - [ ] <!-- rebase-branch=renovate/all-minor-patch -->[fix(deps): update all non-major dependencies](pulls/54) (`argo-cd`, `cert-manager`, `cloudflare`, `code.gitea.io/sdk/gitea`, `docker.io/cloudflare/cloudflared`, `docker.io/kanidm/server`, `external-secrets`, `ghcr.io/gethomepage/homepage`, `ghcr.io/kagent-dev/kagent/tools`, `go`, `grafana`, `ingress-nginx`, `k8s.io/api`, `k8s.io/apimachinery`, `k8s.io/client-go`, `kube-prometheus-stack`, `ollama`, `redis`, `registry.rocket.chat/rocketchat/rocket.chat`, `rook-ceph`, `rook-ceph-cluster`, `supabase/edge-runtime`, `supabase/logflare`, `supabase/postgres`, `supabase/realtime`, `supabase/storage-api`, `zot`)
 - [ ] <!-- rebase-branch=renovate/ghcr.io-kagent-dev-doc2vec-mcp-2.x -->[chore(deps): update ghcr.io/kagent-dev/doc2vec/mcp docker tag to v2](pulls/62)
 - [ ] <!-- rebase-branch=renovate/external-secrets-2.x -->[chore(deps): update helm release external-secrets to v2](pulls/61)
...
<details><summary>docker-compose.yml (13)</summary>
 ...
 - `supabase/realtime v2.73.3` → [Updates: `v2.76.4`]
 - `supabase/storage-api v1.35.3` → [Updates: `v1.37.7`]
 - `darthsim/imgproxy v3.30.1`
 - `supabase/postgres-meta v0.95.2`
 - `supabase/edge-runtime v1.70.0` → [Updates: `v1.70.3`]
 - `supabase/logflare 1.30.5` → [Updates: `1.31.0`]
 - `supabase/postgres 17.6.1.074` → [Updates: `17.6.1.083`]
...
<details><summary>platform/gitea/files/config/go.mod (4)</summary>
 ...
 - `go 1.19`
 - `code.gitea.io/sdk/gitea v0.22.1` → [Updates: `v0.23.2`]
...
<details><summary>platform/global-secrets/files/secret-generator/go.mod (7)</summary>
 ...
 - `go 1.25.0`
 - `go 1.25.6` → [Updates: `1.26.0`]
 - `github.com/sethvargo/go-password v0.3.1`
 - `gopkg.in/yaml.v3 v3.0.1`
 - `k8s.io/api v0.35.0` → [Updates: `v0.35.1`]
 - `k8s.io/apimachinery v0.35.0` → [Updates: `v0.35.1`]
 - `k8s.io/client-go v0.35.0` → [Updates: `v0.35.1`]
...
<details><summary>helm-values (78)</summary>
<blockquote>

<details><summary>apps/ace-step/values.yaml</summary>
...
<details><summary>archived/apps/homepage/values.yaml (1)</summary>
 ...
 - `ghcr.io/gethomepage/homepage v1.9.0` → [Updates: `v1.10.1`]

</details>

<details><summary>archived/apps/kagent/values.yaml (2)</summary>

 - `ghcr.io/kagent-dev/kagent/tools 0.0.13` → [Updates: `0.0.14`]
 - `ghcr.io/kagent-dev/doc2vec/mcp v1.1.14` → [Updates: `2.0.0`]
...
<details><summary>archived/apps/livekit/values.yaml (1)</summary>
 ...
 - `redis 8.4-alpine` → [Updates: `8.6-alpine`]
...
<details><summary>archived/apps/rocket/values.yaml (3)</summary>
 ...
 - `registry.rocket.chat/rocketchat/rocket.chat 8.0.1` → [Updates: `8.1.0`]
 - `mongo 8`
 - `mongo 8`
...
<details><summary>platform/kanidm/values.yaml (1)</summary>
 ...
 - `docker.io/kanidm/server 1.8.5` → [Updates: `1.8.6`]

</details>

<details><summary>system/cloudflared/values.yaml (1)</summary>

 - `docker.io/cloudflare/cloudflared 2026.1.2` → [Updates: `2026.2.0`]
...
<details><summary>helmv3 (82)</summary>
<blockquote>

<details><summary>apps/ace-step/Chart.yaml (1)</summary>
...
<details><summary>platform/external-secrets/Chart.yaml (1)</summary>
 ...
 - `external-secrets 1.3.1` → [Updates: `1.3.2`, `2.0.0`]
...
<details><summary>platform/zot/Chart.yaml (1)</summary>
 ...
 - `zot 0.1.97` → [Updates: `0.1.98`]

</details>

<details><summary>system/argocd/Chart.yaml (2)</summary>

 - `argo-cd 9.3.7` → [Updates: `9.4.1`]
 - `argocd-apps 2.0.4`
...
<details><summary>system/cert-manager/Chart.yaml (1)</summary>
 ...
 - `cert-manager v1.19.2` → [Updates: `v1.19.3`]
...
<details><summary>system/ingress-nginx/Chart.yaml (1)</summary>
 ...
 - `ingress-nginx 4.14.2` → [Updates: `4.14.3`]
...
<details><summary>system/monitoring-system/Chart.yaml (1)</summary>
 ...
 - `kube-prometheus-stack 81.3.0` → [Updates: `81.6.3`]

</details>

<details><summary>system/rook-ceph/Chart.yaml (3)</summary>

 - `rook-ceph v1.19.0` → [Updates: `v1.19.1`]
 - `rook-ceph-cluster v1.19.0` → [Updates: `v1.19.1`]
...
<details><summary>external/modules/cloudflare/versions.tf (3)</summary>
 ...
 - `cloudflare ~> 5.16.0` → [Updates: `~> 5.17.0`]
 - `http ~> 3.5.0`
 - `kubernetes ~> 3.0.0`
