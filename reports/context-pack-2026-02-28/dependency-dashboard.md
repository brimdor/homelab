...
The following updates have all been created. To force a retry/rebase of any, click on a checkbox below.
 ...
 - [ ] <!-- rebase-branch=renovate/all-minor-patch -->[fix(deps): update all non-major dependencies](pulls/67) (`argo-cd`, `bitnamilegacy/postgresql`, `cert-manager`, `docker.io/kanidm/server`, `ghcr.io/kagent-dev/kagent/tools`, `k8s.io/api`, `k8s.io/apimachinery`, `k8s.io/client-go`, `kube-prometheus-stack`, `ollama`, `postgres`, `renovate`, `rook-ceph`, `rook-ceph-cluster`, `supabase/gotrue`, `supabase/logflare`, `supabase/postgres`, `supabase/postgres-meta`, `supabase/realtime`, `supabase/storage-api`)
...
<details><summary>docker-compose.yml (13)</summary>
 ...
 - `supabase/realtime v2.77.0` → [Updates: `v2.78.5`]
 - `supabase/storage-api v1.38.0` → [Updates: `v1.40.0`]
 - `darthsim/imgproxy v3.30.1`
 - `supabase/postgres-meta v0.95.2` → [Updates: `v0.96.0`]
 - `supabase/edge-runtime v1.70.5`
 - `supabase/logflare 1.32.5` → [Updates: `1.33.3`]
 - `supabase/postgres 17.6.1.088` → [Updates: `17.6.1.091`]
...
<details><summary>archived/apps/kagent/values.yaml (2)</summary>
 ...
 - `ghcr.io/kagent-dev/kagent/tools 0.0.15` → [Updates: `0.0.16`]
...
<details><summary>archived/apps/rocket/values.yaml (3)</summary>
 ...
 - `registry.rocket.chat/rocketchat/rocket.chat 8.1.1`
 - `mongo 8`
 - `mongo 8`
...
<details><summary>platform/renovate/Chart.yaml (1)</summary>
 ...
 - `renovate 46.31.4` → [Updates: `46.44.1`]
...
<details><summary>system/monitoring-system/Chart.yaml (1)</summary>
 ...
 - `kube-prometheus-stack 82.2.1` → [Updates: `82.4.3`]
